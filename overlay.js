var _acx_overlay = new function() {
	...
	this.floatdiv_form = this.config_floatdiv_form || "color:#111;width: 100%;font-size: 50pt;padding: 5px;margin-bottom: 10px;text-align: center;font-family: sans-serif;z-index:9999;";
